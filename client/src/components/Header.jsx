    ...
    return (
        ...
        >
            <motion.div
                ...
                className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 py-1 rounded-full border border-neutral500'>
            ...
            <motion.div
                ...
                {Array(6).fill('').map((item, index) => (
                    ...
                    className='rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10'
                        src={index % 2 == 0 ? assets.sample_img_2 : assets.sample_img_1} alt="" srcset="" key={index} width={70} />
                ))}
            </motion.div>
            <motion.p 
            initial={{opacity:0}}
